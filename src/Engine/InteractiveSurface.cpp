 ...
 */
InteractiveSurface::InteractiveSurface(int width, int height, int x, int y, int access_level_required) : Surface(width, height, x, y), _buttonsPressed(0), _in(0), _over(0), _out(0), _isHovered(false), _isFocused(true), _listButton(false), _tftdMode(false), _access_level_required(access_level_required)
{
}
...
bool InteractiveSurface::pressIfTooltipMatches(int access_level, const std::string& textLabel, State* state, bool exactMatch, float xscale, float yscale, float topband, float leftband)
{
