...
public:
	...
	bool pressIfLabelMatches(int access_level, const std::string& labelText, State* state, bool exactMatch, float xscale, float yscale, float topband, float leftband) override;
};
